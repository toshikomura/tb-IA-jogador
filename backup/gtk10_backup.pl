...
min( Tabuleiro, Jogador, Altura, Valor_Fae):-
    ...
    write( Prox_Altura),
    write( '\n\n'),
    conjunto_d_alphas_e_betas( [ [ Alplha, Beta] | Elementos]),
    fae( Prox_Tabuleiro, Jogador, Valor_Fae),
    write( 'Fae = '),
    write( Valor_Fae),
    write( '\n'),
    menor( Beta, Valor_Fae, Menor_Beta),
    write( 'Menor_Beta = '),
    write( Menor_Beta),
    write( '\n'),
%    remove_um_elemento_alpha_beta( _),
%    insere_um_elemento_alpha_beta( [ Aplha, Menor_Beta]),
...
%    menor( Beta, Valor_Fae_R, Beta_Menor),
%    remove_um_elemento_alpha_beta( _),
%    insere_um_elemento_alpha_beta( [ Alpha, Beta_Menor]),
%    Alpha >= Beta_Menor, % Poda
%    Valor_Fae is Beta_Menor,
%    remove_um_elemento_alpha_beta( _),
    Valor_Fae is 3,
    !.
...
%    Alpha_Maior >= Beta, % Poda
    Valor_Fae is Alpha_Maior,
    remove_um_elemento_alpha_beta( _),
    !.
...
jogada_plausivel_poda_ab( Tabuleiro, Jogador, Altura, _):-
    ...
    fae( Prox_Tabuleiro, Adversario, Valor_Fae),
    write( Valor_Fae),
    write('\n'),
    insere_melhor_jogada( Prox_Tabuleiro, Valor_Fae), % Coloca a melhor jogada
...
%    adjacente( Tabuleiro, Jogador, Proximo),
    Valor_Fae is Beta_Menor,
%    fae( Proximo, Jogador, Valor_Fae),
%    write('Fae = '),
%    write( Valor_Fae),
%    write('\n'),
%    write('Tabuleiro = '),
